      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Standard configuration popup with amber theme matching the
              existing design.
            </p>
            <Button
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Automatically shows when configuration is missing. Status:{" "}
              {autoPopup.isConfigured ? "✅ Configured" : "❌ Missing"}
            </p>
            <Button
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-gray-50 rounded-lg text-sm space-y-1">
              <div className="flex items-center gap-2">
                <span
                  className={
                    autoPopup.isConfigured ? "text-green-600" : "text-red-500"
                  }
                >
                  {autoPopup.isConfigured ? "✅" : "❌"}
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="bg-blue-50 p-3 rounded-lg">
              ...
              <p className="text-blue-700 text-xs">
                Basic conversation component with setup popup triggered when
            ...
            <div className="bg-purple-50 p-3 rounded-lg">
              ...
              <p className="text-purple-700 text-xs">
                Advanced conversation features with configuration popup for
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
          ...
          <div className="text-sm text-amber-700 space-y-1">
            <p>
              • <strong>Primary:</strong> Amber colors matching existing
              configuration warnings
            </p>
            <p>
              • <strong>Actions:</strong> Gradient buttons for guided setup,
              amber for quick setup
            </p>
            <p>
              • <strong>Status:</strong> Green for success, red for errors,
              amber for warnings
            </p>
            <p>
              • <strong>Layout:</strong> Responsive modal with backdrop,
              matching shadcn/ui design
            </p>
          </div>
        </div>
      </CardContent>
