      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the future of voice interactions with advanced
            visualizations, real-time analytics, multiple AI personas, and
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-800 mb-3">
                To experience all advanced features, configure your ElevenLabs
                credentials:
              </p>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <br />
                  Multiple visualization modes: Orb, Waveform, and Spectrum
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-500 font-bold">✓</span>
                <div>
                  ...
                  <br />
                  Track sentiment, word count, duration, and key topics
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-500 font-bold">✓</span>
                <div>
                  ...
                  <br />
                  Switch between different agent personalities and voices
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-500 font-bold">✓</span>
                <div>
                  ...
                  <br />
                  Download conversations with timestamps and speaker
                  identification
                </div>
              </li>
            </ul>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <br />
                  Clone and use your own voice for conversations
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 font-bold">⏳</span>
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <br />
                  Control app features through voice interactions
                </div>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 font-bold">⏳</span>
                <div>
                  ...
                  <br />
                  Calendar, notes, tasks, and productivity tools
                </div>
              </li>
            </ul>
          </div>
